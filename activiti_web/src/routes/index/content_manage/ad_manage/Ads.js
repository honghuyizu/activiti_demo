...
import CAction from '../../../../components/index/content_manage/ad_manage/ad/CAction';
import CSearch from '../../../../components/index/content_manage/ad_manage/ad/CSearch';
import styles from '../../../../styles/util/ListLayout.less';
import * as projectUtil from '../../../../utils/rbacProjectUtil';

function Ads({ children, dispatch, ads }) {
  const { curActionName, actionBarVisible, curAdPositionID, adPositionDataSource, conditionName, current, pageSize, selectedRowKeys } = ads;
  const actionProps = {
    gotoAdd() {
      dispatch({
        type: 'ads/gotoAdd',
