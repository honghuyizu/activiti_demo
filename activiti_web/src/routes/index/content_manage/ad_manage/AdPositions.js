...
import CAction from '../../../../components/index/content_manage/ad_manage/ad_position/CAction';
import CSearch from '../../../../components/index/content_manage/ad_manage/ad_position/CSearch';
import styles from '../../../../styles/util/ListLayout.less';
import * as projectUtil from '../../../../utils/rbacProjectUtil';

function AdPositions({ children, dispatch, adPositions }) {
  const { curActionName, actionBarVisible, conditionName, current, pageSize, selectedRowKeys } = adPositions;
  const actionProps = {
    gotoAdd() {
      dispatch({
