...
export function isCmccMobile(strInput) {
  let reg = /(^13[4-9]\d{8}$)|(^14[0,7]\d{8}$)|(^15[0,1,2,4,7,8,9]\d{8}$)|(^165\d{8}$)|(^170[3,5,6]\d{7}$)|(^178\d{8}$)|(^18[2,3,4,7,8]\d{8}$)/;
...
export function isCutcMobile(strInput) {
  let reg = /(^13[0-2]\d{8}$)|(^14[1,3,5]\d{8}$)|(^15[5,6]\d{8}$)|(^170[7,8,9]\d{7}$)|(^171[8,9]\d{8}$)|(^17[5,6]\d{8}$)|(^18[5,6]\d{8}$)/;
  return reg.test(strInput);
}
...
export function isCtccMobile(strInput) {
  let reg = /(^133\d{8}$)|(^14[2,4,6,8,9]\d{8}$)|(^153\d{8}$)|(^170[0,1,2]\d{7}$)|(^17[3,7]\d{8}$)|(^18[0,1,9]\d{8}$)/;
  return reg.test(strInput);
}
