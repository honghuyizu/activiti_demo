...
import { getPageList, getBean, add, edit, remove, removeBatch } from '../../../../services/index/content_manage/carousel_manage/carousels';
...
export default {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        ...
        } else if (location.pathname === '/index/content_manage/carousel_manage/carousels/add') {
          dispatch({
            type: 'initAdd'
          });
        } else if (pathToRegexp('/index/content_manage/carousel_manage/carousels/carousel/:id').test(location.pathname)) {
  ...
  effects: {
    ...
    *initAdd({ payload }, { call, put }) {
      yield put({ type: 'setValue', payload: { curAction: 'add', curActionName: '新增轮播图', curRecord: {}, actionBarVisible: false } });
    },
