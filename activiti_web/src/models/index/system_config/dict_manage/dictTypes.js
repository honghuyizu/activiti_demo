...
import { getPageList, getBean, add, edit, remove, removeBatch, changeOrderBy } from '../../../../services/index/system_config/dict_manage/dictTypes';
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        ...
        } else if (location.pathname === "/index/system_config/dict_manage/dict_types/add") {
          dispatch({
            type: 'initAdd'
          });
        } else if (pathToRegexp("/index/system_config/dict_manage/dict_types/dict_type/:id").test(location.pathname)) {
  ...
  effects: {
    ...
    *initEdit({ payload }, { call, put }) {
      ...
      if (data) {
        console.log('data:', JSON.stringify(data));
        if (data.code === projectConstant.CODE_SUCCESS) {
          yield put({ type: 'setValue', payload: { curAction: 'edit', curActionName: "编辑类型", curRecord: data.data, actionBarVisible: false } });
        }
      }
    },
