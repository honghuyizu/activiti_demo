...
import { getPageList, getBean, add, edit, remove, removeBatch } from '../../../../services/index/system_config/task_manage/tasks';
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen(location => {
        ...
        } else if (location.pathname === '/index/system_config/task_manage/tasks/add') {
          dispatch({
            type: 'initAdd'
          });
        } else if (pathToRegexp('/index/system_config/task_manage/tasks/task/:id').test(location.pathname)) {
